(function(t) {
    ...
    function u(a, b) {
        ...
        try {
            ...
            if (b && ("function" ===
                ...
                var e = b.then;
                if ("function" === typeof e) return e.call(b, function(d) {
    ...
    "undefined" !== typeof exports && exports ? exports.Promise = f || g : C || (t.Promise = f);
    var s = "pending",
        w = "sealed",
        l = "fulfilled",
        r = "rejected",
        D = function() {}, y = "undefined" !== typeof setImmediate ?
    ...
    f.prototype = {
        ...
        then: function(a, b) {
            ...
            this.state_ === l || this.state_ === r ? n(q, c) : this.then_.push(c);
            return c.then
        },
        "catch": function(a) {
    ...
    f.all = function(a) {
        if (!Array.isArray(a)) throw new TypeError("You must pass an array to Promise.all().");
        return new this(function(b, c) {
            ...
            for (var d = [],
                    f = 0, g = 0, h; g < a.length; g++)(h = a[g]) && "function" === typeof h.then ? h.then(e(g), c) : d[g] = h;
            f || b(d)
        })
    };
    f.race = function(a) {
